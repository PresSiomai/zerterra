...
<div class="columns has-text-centered" style="height: 100px; background-color: #f2f2f2;">
  <div class="column is-5" style="padding-top: 20px;" >
    <span style="padding-left: 150px;">  APPROVE USERS  </span> 
  </div>
...
<!-- TABLE CONTENT -->
 ...
 <tbody>
                         ...
                         $sql = "SELECT * FROM approve_list WHERE is_pending='1'" ;
                    ...
                    <button  data-target="#detail<?php echo $id;?>" class="button is-primary is-small modal-button" id="btn_update" name="btn-update"><i class="far fa-edit"></i>
                           </button>
                             <div id="detail<?php echo $id; ?>" class="modal" role="dialog">
                               <div class="modal-background"></div>
                      ...
                      <button type="submit" name="updated_user" class="button is-primary"><i class="fas fa-shipping-fast"></i>
                       Delivered</button>
