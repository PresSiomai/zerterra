...
">
  ...
  <div class="container">
              ...
              <header class="modal-card-head">
                ...
                <div class="media-content">
                <img src="images/pendingIcon.png" style="height: 126px; width: 126px; ">
                <a href="approve.php"><P>APPROVE</P></a>
                </div>
  ...
  <div class="column is-5" style="padding-top: 20px;" >
   ...
   <div class="column is-10" style="padding-top: 30px;">
    ...
    <div>
      ...
      <button style="margin: 0; margin-left: 250px;" class="button is-green modal-button" data-target="#myModal" aria-haspopup="true">
      <i class="fas fa-user-plus"></i> ADMIN</button>
