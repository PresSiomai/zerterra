...
">
  ...
  <a id="modal_button"  class="modal-button" data-target="#transModal" >TRANSACTIONS</a>
  </span>
 <div class="container">
 
                    <div id="transModal" class="modal modal-fx-slideTop">
              ...
              <header class="modal-card-head">
                    <p class="modal-card-title" style="text-align: center">TRANSACTIONS OPTIONS</p>
                   </header>
                <div>
                <div class="columns">
...
<div class="columns has-text-centered" style="height: 100px; background-color: #f2f2f2;">
  <div class="column is-5" style="padding-top: 20px;" >
    <span style="padding-left: 150px;">  PENDING USERS  </span> 
  </div>
...
<!-- TABLE CONTENT -->
 ...
 <tbody>
                    ...
                    <td>
                      ...
                      <div class="control" >
                        <input class="input2" type="text"  name="edit_fname" value="<?php echo $fname; ?>" required="">
                      </div>
                      <div class="control">
                        <input class="input2" type="text" name="edit_lname" value="<?php echo $lname; ?>" required="">
                      </div>
                      <div class="control">
                        <input class="input2" type="email" name="edit_email" value="<?php echo $email; ?>"   required="">
                      </div>
                      <div class="control">
                        <input class="input2" type="text" name="edit_address" value="<?php echo $Address; ?>"  required="">
                      </div>
                      <div class="control">
                        <input class="input2" type="number" name="edit_contact" value="<?php echo $Contact; ?>"  required="">
                      </div>
                      ...
                      <button class="button is-danger">Cancel</button>
                             ...
                             <button class="button is-danger is-small modal-button" data-target="#myModal" aria-haspopup="true"><i class="far fa-eye"></i></button>
                          </button></a>
  ...
  <div class="modal-card">
    <header class="modal-card-head">
     ...
     <div class="field">
                      ...
                      <div class="control">
                        <input class="input1" type="text" name="edit_fname" disabled value="<?php echo $fname; ?>" required="">
                      </div>
                      <div class="control">
                        <input class="input1" type="text" name="edit_lname" disabled value="<?php echo $lname; ?>" required="">
                      </div>
                      <div class="control">
                        <input class="input1" type="email" name="edit_email" disabled value="<?php echo $email; ?>"   required="">
                      </div>
                      <div class="control">
                        <input class="input1" type="number" name="edit_contact" disabled value="<?php echo $Contact; ?>"  required="">
                      </div>
                      <div class="control">
                        <input class="input1" type="text" name="edit_address" disabled value="<?php echo $Address; ?>"  required="">
                      </div>
                      <div class="control">
...
if(isset($_POST['btn_add_user'])){
  ...
  $Message = $_POST['Message'];
        ...
        $sql ="INSERT INTO pending_list (FirstName,LastName,Email,ContactNumber,Address,Message) VALUES ('$fname','$lname','$email','$address','$contact')";
      ...
      if(isset($_POST['acnt_remove'])){
        ...
        $sql= "UPDATE pending_list SET is_active='0' WHERE id='$delete_id'";
        if($con->query($sql) === TRUE){
      ...
      if(isset($_POST['updated_user'])){
        ...
        $sql = "UPDATE pending_list SET FirstName='$fname',LastName='$lname',Email='$Email',Address='$Address', ContactNumber='$Contact' WHERE id='$id'";
        if($con->query($sql) === TRUE){
